...
namespace FezGame.ChaosMod
{
    public class ChaosModEffectText : IDisposable
    {
        ...
        internal void Draw(string text, double progress, int offset, string CircleText, Color color, bool isPaused)
        {
            ...
            circularProgressBar.DrawProgressCircle(progress, CircleText, vector, scale, isPaused);
