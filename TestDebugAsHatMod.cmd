...
@FOR /F "tokens=2* skip=2" %%a in ('reg query "HKCU\SOFTWARE\Valve\Steam" /v "SteamPath"') do set fezpath="%%b/steamapps/common/FEZ/Mods/FezChaosMod"
...
@if ERRORLEVEL 0 (
	...
	copy "D:\Github\FezChaosMod\Metadata.xml"
